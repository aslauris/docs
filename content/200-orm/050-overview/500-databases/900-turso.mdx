...
It could be also implemented it as a [Prisma Client extension](https://www.prisma.io/docs/orm/prisma-client/client-extensions). The example below shows auto-syncing after write operation (create, update or delete) is performed.
